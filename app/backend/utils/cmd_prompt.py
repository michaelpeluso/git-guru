...
from app.backend.utils.file_manager import Utils
from repo_retrieval.repo_retrieval import RepoRetrieval
    ...
    def execute(self, *args, **kwargs):
        ...
        while True:
            ...
            # send files to ai
                ...
                try:
                    response, tokens_used = Utils.interact_with_ai(user_code_input, character_name)
            ...
            '''
            try:
                response, tokens_used = Utils.interact_with_ai(user_input, character_name)
                print(f"AI Agent: {response}")
                print(f"(This interaction used {tokens_used} tokens.)")
                self.history.append(("system", response))
            except Exception as e:
